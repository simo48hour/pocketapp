...
import { User, Settings, Bell, Star, Database, Cloud, Laptop, Github, Wrench, List, Rocket } from 'lucide-react';
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  deployments: 'Manage and monitor your live published applications',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'deployments', visible: true, window: 'user' as const, order: 2 },
