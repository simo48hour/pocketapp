...
??? question "What are the best models for PocketApp?"
For the best experience with PocketApp, we recommend using the following models from our 19 supported providers:
...
PocketApp uses a modular provider architecture. To add a new provider:
...
PocketApp provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with PocketApp?"
...
MCP extends PocketApp's AI capabilities with external tools:
...
??? question "How do I deploy my PocketApp projects?"
PocketApp supports one-click deployment to multiple platforms:
...
PocketApp provides comprehensive Git and GitHub integration:
...
??? question "How do I contribute to PocketApp?"
Check out our [Contribution Guide](CONTRIBUTING.md) for more details on how to get involved!

??? question "What are the future plans for PocketApp?"
Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates.  
 New features and improvements are on the way!

??? question "Why are there so many open issues/pull requests?"
PocketApp began as a small showcase project on an open-source AI full-stack development studio featuring embedded PocketBase databases and in-browser execution.

    We're forming a team of maintainers to manage demand and streamline issue resolution. The maintainers are rockstars, and we're also exploring partnerships to help the project thrive.

## New Features & Technologies

??? question "What's new in PocketApp?"
Recent major additions to PocketApp include:
...
PocketApp offers templates for popular frameworks and technologies:

    **Getting Started:**
    1. Start a new project in PocketApp
...
Use Supabase for backend database functionality:
    ...
    **Setup Process:**
    ...
    3. Configure the connection in your PocketApp project
...
??? question "How do local LLMs compare to larger models like Claude 3.5 Sonnet for PocketApp?"
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of PocketApp
...
**Windows development environment**: Install Visual Studio C++ (version 14.40.33816 or later). More details in [GitHub Issues](https://github.com/simo48hour/pocketapp/issues)
...
[Join the PocketApp Community](https://github.com/simo48hour/pocketapp/discussions){target=\_blank} for discussions and help

!!! bug "Report Issues"
[Open an Issue](https://github.com/simo48hour/pocketapp/issues){target=\_blank} in our GitHub Repository
