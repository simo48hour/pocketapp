...
export default defineConfig({
  ...
  theme: {
    colors: {
      ...
      ring: 'var(--bolt-elements-borderColorActive)',
      background: 'var(--bolt-elements-bg-depth-1)',
      foreground: 'var(--bolt-elements-textPrimary)',
      card: {
        DEFAULT: 'var(--bolt-elements-bg-depth-2)',
        foreground: 'var(--bolt-elements-textPrimary)',
      },
      muted: {
        DEFAULT: 'var(--bolt-elements-bg-depth-2)',
        foreground: 'var(--bolt-elements-textSecondary)',
      },
      popover: {
        DEFAULT: 'var(--bolt-elements-bg-depth-2)',
        foreground: 'var(--bolt-elements-textPrimary)',
      ...
      accent: {
        ...
        DEFAULT: 'var(--accent, rgba(124, 58, 237, 0.1))',
        foreground: 'var(--accent-foreground, #7c3aed)',
      },
      bolt: {
        elements: {
