...
Welcome! This guide provides all the details you need to contribute effectively to the project. Thank you for helping us make **PocketApp** a better tool for developers worldwide. 💡
...
### 3️⃣ Join as a Contributor

Interested in maintaining and growing the project? Open an issue or join the conversation in [GitHub Discussions](https://github.com/simo48hour/pocketapp/discussions).
...
```bash
docker run -p 5173:5173 --env-file .env.local pocketapp:development
```
...
```bash
docker build . --target pocketapp-production
```
